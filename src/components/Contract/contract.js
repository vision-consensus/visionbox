...
const VisionWrap = require('../VisionWrap')
...
const contract = (function (module) {
  ...
  const Utils = {
    ...
    linkBytecode: function (bytecode, links) {
      Object.keys(links).forEach(function (library_name) {
        ...
        // var address = VisionWrap.address2HexString(library_address);
  ...
  function filterEntropyParameter(args) {
  ...
  Contract._static_methods = {
    ...
    initVisionWeb: function (options) {
      if (!visionWrap) {
        visionWrap = VisionWrap(options)
      }
    },
    ...
    new: function () {
      ...
      const [args, params] = filterEntropyParameter(Array.prototype.slice.call(arguments))
      ...
      return new Promise(function (accept, reject) {
        ...
        visionWrap._deployContract(tx_params, _callback)
    ...
    at: function () {
      ...
      throw new Error('The construct contractArtifacts.at(address) is not currently supported by VisionBox. It will be in the future. Stay in touch.')
    ...
    call: function (methodName, ...args) {
      ...
      return new Promise(function (accept, reject) {
        ...
        visionWrap.triggerContract(option, _callback)
      })
    },
    deployed: function () {
      const self = this
      return new Promise(function (accept, reject) {
        ...
        VisionWrap().vs.getContract(self.address)
          .then(res => {
