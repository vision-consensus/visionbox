...
const logErrorAndExit = require('../VisionWrap').logErrorAndExit
let visionWrap
...
const Migrate = {
  ...
  lastCompletedMigration: function (options, callback) {
    ...
    // if called from console, visionWrap is null here
    ...
    Migrations.deployed().then(function (migrations) {
      ...
      return (visionWrap.filterMatchFunction('last_completed_migration', migrations.abi))
      ...
      callback(null, visionWrap._toNumber(value))
    }).catch(() => {
      // first migration:
      callback(null, 0)
    })
